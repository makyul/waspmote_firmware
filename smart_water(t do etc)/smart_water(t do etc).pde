...
void create_file(int dop)
{
  ...
  snprintf(filename, sizeof(filename), "WATER%d.TXT", files_number);
...
void loop()
{
  ...
  frame.addSensor(SENSOR_STR, DOValue);
  frame.addSensor(SENSOR_STR, ORPValue);
